...
<div class="sidebar">
 <a href="tgcustomer.php">Home</a>
  ...
  <a class="active" href="tgcancelbooking.php">Cancel Booking</a>
...
<div class="table-scrol">  
    <h1 style="color:#29bfca"><b>Cancel Booking</b></h1>
...
<td><?php echo $btime;  ?></td>  
            <td><a href="deletebooking.php?del=<?php echo $b_id ?>"><button class="removehelperbtn">Cancel</button></a></td>   
        </tr>  
